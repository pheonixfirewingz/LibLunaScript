...
static const std::ReadOnlyLookupTable<data_size_t, LexerToken> lookup = {
    ...
    {std::hash<std::string>{}("jmp"), LexerToken::JMP},     {std::hash<std::string>{}("skip"), LexerToken::SKIP},
    {std::hash<std::string>{}("cmp"), LexerToken::CMP},     {std::hash<std::string>{}("ncmp"), LexerToken::NCMP},
    {std::hash<std::string>{}("push"), LexerToken::PUSH},   {std::hash<std::string>{}("pop"), LexerToken::POP},
